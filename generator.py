...
if __name__ == "__main__":
    ...
    corpus = [
        [ "sam", "i", "am" ],['Hello','i','am','haha']
    ]
#     corpus = []
#     corpus = ['Hello','I','am','haha']
#     unigram.fit_corpus(corpus)
#     print(unigram.model)
#     sampler = Sampler(unigram)
#     print("train:", unigram.perplexity(corpus))
#     for i in range(10):
#         print(i, ":", " ".join(str(x) for x in sampler.sample_sentence([])))
        
#     print(1)
    ngram.fit_corpus(corpus)
    print()
#     print(ngram.phraseFrequency)
#     print(ngram.prefixFrequency)
    print()
    sampler = Sampler(ngram)
    print("train:", ngram.perplexity(corpus))
#     for i in range(10):
#         print(i, ":", " ".join(str(x) for x in sampler.sample_sentence([])))
